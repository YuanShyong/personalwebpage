...
export const researchConfig: ResearchConfigData = {
  researchStatement: "My research centers on Differential Geometry and Geometric Analysis, with an emphasis on minimal submanifolds, mean curvature flow (MCF), self-similar soliton solutions (such as translating solitons and $\\lambda$-translators), higher codimension geometric systems, and Dirichlet boundary problems for minimal graphs.",
  ...
  researchCategories: [
    ...
    },
    {
      ...
      items: [
        ...
        "Stability properties and rigidity results for $\\lambda$-translating hypersurfaces moving along non-graphical directions."
      ]
    },
    {
      id: "geometric-pdes",
  ...
  keyMathTopics: [
    ...
    {
      title: "\\lambda-Translating Hypersurfaces",
  ...
  year={2019}
    ...
    },
    {
      ...
      doi: "",
      arxiv: "2501.99999",
      abstract: "Investigates stability notions for \\lambda-translators and proves characterization and rigidity theorems in weighted Riemannian manifolds.",
      tags: ["\\lambda-Translators", "Stability", "Weighted Manifolds"],
